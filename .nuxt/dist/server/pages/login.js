...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/login.vue?vue&type=template&id=4f6996fa&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"fill-height":"","fluid":""}},[_c('v-row',{directives:[{name:"show",rawName:"v-show",value:(!_vm.$auth.loggedIn),expression:"!$auth.loggedIn"}],staticStyle:{"display":"none"},attrs:{"justify":"center","align":"center"}},[_c('v-card',{staticClass:"pa-5 shrink",attrs:{"width":"400","color":"#FAFAFA"}},[_c('v-card-title',{staticClass:"justify-center"},[_c('span',{staticClass:"text-h4 font-weight-bold"},[_vm._v("管理系統")])]),_vm._v(" "),_c('v-form',{on:{"submit":function($event){$event.preventDefault();return _vm.userLogin.apply(null, arguments)}}},[_c('v-col',[_c('p',{staticClass:"font-weight-bold"},[_vm._v("\n            帳號\n          ")]),_vm._v(" "),_c('v-text-field',{staticClass:"mt-3",attrs:{"outlined":"","hide-details":"","type":"text","autocomplete":"off"},model:{value:(_vm.login.username),callback:function ($$v) {_vm.$set(_vm.login, "username", $$v)},expression:"login.username"}})],1),_vm._v(" "),_c('v-col',[_c('p',{staticClass:"font-weight-bold"},[_vm._v("\n            密碼\n          ")]),_vm._v(" "),_c('v-text-field',{staticClass:"mt-3",attrs:{"outlined":"","hide-details":"","autocomplete":"off","type":_vm.showPwd ? 'text' : 'password',"append-icon":_vm.showPwd ? 'mdi-eye' : 'mdi-eye-off'},on:{"click:append":function($event){_vm.showPwd = !_vm.showPwd}},model:{value:(_vm.login.password),callback:function ($$v) {_vm.$set(_vm.login, "password", $$v)},expression:"login.password"}})],1),_vm._v(" "),_c('v-col',[_c('v-btn',{staticClass:"text-h6 font-weight-medium",attrs:{"type":"submit","block":"","color":"black","height":"55","dark":""}},[_vm._v("\n            登入\n          ")])],1)],1)],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/login.vue?vue&type=template&id=4f6996fa&
...
//
//
const md5 = __webpack_require__(70);
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardTitle: components_VCard["c" /* VCardTitle */],VCol: VCol["a" /* default */],VContainer: VContainer["a" /* default */],VForm: VForm,VRow: VRow["a" /* default */],VTextField: VTextField["a" /* default */]})
